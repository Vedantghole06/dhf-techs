...
const Services = () => {
  ...
  return (
    <div className="min-h-screen bg-black pt-16">
      ...
      <section id="engineering-services" className="py-20" ref={servicesRef}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div
          ...
          >
            ...
            <p className="text-gray-300 text-lg max-w-2xl capitalize">
          ...
          <motion.div
            ...
            className="text-left mb-16"
          >
            <div id="it-solutions" className="flex items-center space-x-4 mb-6">
